...
<body>
  ...
  <h1 class="one">Employee Dashboard</h1>
  <p>To add an item to the inventory, <a href="AddNewItem_Keith.php">click here</a> </p>
  <p>To modify an item, <a href="ModifyItems_Keith.php">click here</a> </p>
  <p>To delete item, <a href="DeleteItems_Keith.php">click here</a> </p>
  <p>To view item price data, <a href="ItemData_Keith.php">click here</a> </p>
  <p><a href="EmployeeLoginPage_Keith.php">Log out</a> </p>
  <br /> <br />
  <footer class="foot">
        <br /><br /><br /><br />
  </footer>
